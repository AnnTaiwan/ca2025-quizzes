...
CLZ:
    li t0, 32         # n = 32, max count of leading zeros
    beq a0, x0, done  # if input is 0, return 32

    li t1, 16
loop1:
    srl t2, a0, t1    # shift right by t1
    beq t2, x0, shift_down
    sub t0, t0, t1    # subtract bits shifted if non-zero
    add a0, t2, x0
shift_down:
    srli t1, t1, 1
    bnez t1, loop1    # repeat until t1 == 0

done:
    sub a0, t0, a0    # final CLZ result in a0
    jr ra
